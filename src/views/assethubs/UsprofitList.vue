    ...
    <a-card :bordered="false">
      ...
      >
        <template slot="type" slot-scope="text, record">
          <span v-if="record.type === 'in'">普通充币</span>
          <span v-else-if="record.type === 'out'">普通提币</span>
          <span v-else-if="record.type === 'system'">其他</span>
          <span v-else-if="record.type === 'transfer'">划转</span>
        </template>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      const res = await getUsprofitList(this.queryParam)
