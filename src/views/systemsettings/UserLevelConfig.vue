    ...
    <a-card :bordered="false">
      ...
      >
        <span slot="action" slot-scope="text, record">
          <template>
            <a @click="handleEdit(record)" :disabled="!$verify('1070017')">编辑</a>
...
// import CreateForm from './modules/UserLevelConfigForm'
...
const modalOptions = [
  ...
  },
  {
    ...
    type: 'input',
    placeholder: '请输入',
    decorator: { rules: [{ required: true, message: '手续费折扣不能为空' }] }
  },
  {
    title: '赠送数量',
    field: 'number',
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      const res = await getUserLevelList(this.queryParam)
