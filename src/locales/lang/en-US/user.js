export default {
  ...
  'user.login.username.placeholder': 'Enter Account',
  'user.login.password.placeholder': 'Enter Password',
  ...
  'user.login.mobile.verification-code.placeholder': 'Google Verification code',
